...
test('Header contains sessionTimeoutModal,inactivityModal correct number of nav items and excludes PDRs and Logs', function (t) {
  const dispatch = () => {};
  const api = {
    authenticated: true
  }
  ...
  const modalActivity = container.querySelector('.inactivity-modal');
  t.truthy(modalActivity);
