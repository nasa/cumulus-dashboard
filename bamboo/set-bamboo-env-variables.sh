...
declare -a param_list=(
    ...
    "bamboo_SIT_DASHBOARD_KIBANA_CLOUDWATCH_UUID"
    "bamboo_SIT_DASHBOARD_KIBANA_DISTRIBUTION_UUID"
    "bamboo_SIT_DASHBOARD_KIBANA_GRANULES_UUID"
    "bamboo_SIT_DASHBOARD_KIBANA_SECURITY_TENANT"
)
